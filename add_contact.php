...
//Run Query
$db->query("INSERT INTO `contacts` (first_name, last_name, email, phone, address1, address2, city, state, zipcode, contacts_group, notes)
...
$db->bind(':contact_group', $_POST['contacts_group']);
